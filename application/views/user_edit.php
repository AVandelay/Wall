...
<?php 	}
		...
		{	?>						
						<a href="/users/show/<?= $user->id?>" class="btn btn-mini btn-link">Back to my profile</a>
<?php   }	?>						
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="span6">
					<div class="well">
						...
						<form id="update_user_info" action="/users/update_user/<?= $user->id?>" method="post" class="edit_user form-horizontal">
...
<?php   if($user_level == ADMIN && $user_id != $user->id)
		{	?>								
								...
								<select name="user_level" id="user_level">
									...
									<option value="9" <?= $user->user_level == ADMIN ? "selected='selected'" : "" ?>>Admin</option>							
								</select>								
<?php   }	?>									
							</div>
							<div class="control-group">
				...
				<div class="span6">
					<div class="well">
						...
						<form id="update_user_password" action="/users/update_user/<?= $user->id?>" method="post" class="edit_user form-horizontal">
							<div class="control-group">
			...
			<div class="row">
				<div class="span12">
					<div class="well">
						...
						<form id="update_user_description" action="/users/update_user/<?= $user->id?>" method="post" class="edit_user form-horizontal">
							<div class="control-group">
